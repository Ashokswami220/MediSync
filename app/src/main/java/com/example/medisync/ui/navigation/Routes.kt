...
object Routes {
    ...
    const val LANG_SELECTION = "lang_selection_screen"

    // User Screens
    const val USER_HOME = "user_home_screen"
    const val USER_REPORTS = "user_reports_screen"
    const val REPORT_DETAIL = "report_detail_screen"
    
    // Role Decision
    const val ROLE_DECIDE = "role_decide_screen"
}